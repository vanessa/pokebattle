...
def get_winner_pokemon(creator_pokemon, opponent_pokemon):
    return compare_attack_to_defense(creator_pokemon, opponent_pokemon)


def compare_two_pokemons_and_return_winner(creator_pokemon, opponent_pokemon):
    ...
    return get_winner_pokemon(creator_pokemon, opponent_pokemon)
...
def compare_two_pokemons(creator_pokemon_id, opponent_pokemon_id):
    ...
    return compare_two_pokemons_and_return_winner(creator_pokemon, opponent_pokemon)
